...
public class CucumberPractice {
	...
	@Given("person is unregistered")
	public void person_is_unregistered() throws Throwable {
	...
	@When("person enters details")
	public void person_enters_details() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
		d.findElement(By.linkText("SignUp")).click();
		d.findElement(By.id("userName")).sendKeys("Sidney1");
	...
	@Then("he is redirected")
	public void he_is_redirected() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
